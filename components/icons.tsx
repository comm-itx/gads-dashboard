...
// Using inline SVGs to avoid dependency on an icon library for this simple case.
// In a larger app, using a library like lucide-react would be better.
...
export const WandSparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m5 3-3 3 3 3 3-3-3-3zM19 3l3 3-3 3-3-3 3-3zM3 19l3-3 3 3-3 3-3-3zM19 21l3-3-3-3-3 3 3 3zM11 5l-1.29 2.71L7 9l2.71 1.29L11 13l1.29-2.71L15 9l-2.71-1.29L11 5z"/>
    </svg>
);
